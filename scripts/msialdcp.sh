...
defoghaze() {
    ...
    local hazy_dir="./hazy"
    local gt_dir="./GT"
    local result_dir="./results_fw_${fusion_weight}" && mkdir -p "$result_dir"
...
# arf=0.05
# echo -e "\033[0;32mStart executing on HSTS...\033[0m" && echo
# for fw in "${fusion_weights[@]}"; do
#     defoghaze "$base_dir" "$fw" "$arf"
# done
# echo && echo -e "\033[0;32mDone on HSTS\033[0m"
