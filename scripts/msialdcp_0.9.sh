...
python $defoghaze_path $base/'hazy_1' -gp=$base/'GT_1' -op=$base/'results/1' -dm=0 -ps=30 -fw=0.9 -arf=0.1 -pp=1 <<< $algo
python $defoghaze_path $base/'hazy_2' -gp=$base/'GT_2' -op=$base/'results/2' -dm=0 -ps=30 -fw=0.9 -arf=0.1 -pp=1 <<< $algo
wait
